...
/**
 * Hardware-agnostic interface for triggering haptic feedback.
 * This allows subsystems to request rumble without needing to know
 * anything about the input HID or controller type.
 */
